...
- **闪卡与复习**：单词、音频片段、AI 问答卡；SM-2 计划复习；文本、目录和 Anki 导入。
...
备份包括词卡、音视频学习附件、字幕、收藏、复习计划、统计、OCR 与跟读结果。凭证、设备设置、未收藏的最近视频、聊天会话草稿、原始 OCR 图片和跟读录音不纳入备份。凭证目前保存在本机应用数据库；云端备份通过 HTTPS 传输，尚无端到端加密。
